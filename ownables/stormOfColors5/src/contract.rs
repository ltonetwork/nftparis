...
const CONTRACT_NAME: &str = "crates.io:ownable-storm5";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("Storm of Colors 5".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("Storm of Colors 5".to_string()),
        name: Some("Storm of Colors 5".to_string()),
