...
const CONTRACT_NAME: &str = "crates.io:ownable-dreamgirl";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("dreamgirl".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("Dreamgirl by Pat Smith".to_string()),
        name: Some("Dreamgirl".to_string()),
