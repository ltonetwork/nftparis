...
const CONTRACT_NAME: &str = "crates.io:ownable-taytay";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("Thanks to the Swifties".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("Thank you Swifties for all the support".to_string()),
        name: Some("Thanks from Taytay".to_string()),
