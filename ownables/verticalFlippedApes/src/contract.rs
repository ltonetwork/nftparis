...
const CONTRACT_NAME: &str = "crates.io:ownable-flippedApes";
...
pub fn instantiate(
    ...
    let ownable_info = OwnableInfo {
        ...
        ownable_type: Some("vertical flipped apes".to_string()),
    };
    ...
    let metadata = Metadata {
        ...
        image_data: None,
        external_url: None,
        description: Some("Vertical Flipped Apes".to_string()),
        name: Some("Vertical flipped Apes".to_string()),
